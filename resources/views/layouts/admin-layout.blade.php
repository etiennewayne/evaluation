  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">ADMINISTRATOR<!--<sup>2</sup>--></div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="/cpanel-home">
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="/cpanel-academicyear">Academic Year</a>
            <a class="collapse-item" href="/cpanel-category">Categories</a>
            <a class="collapse-item" href="/cpanel-criteria">Criteria</a>
			<a class="collapse-item" href="/cpanel-users">Users</a>
          </div>
        </div>
      </li>
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="forgot-password.html">Forgot Password</a> --}}
              ...
              <a class="collapse-item" href="/enrolee-courses-uploader">Enrolee Courses Uploader</a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Gov. Alfonso D. Tan College, 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
...
<script src="{{asset('js/bootstrap.bundle.min.js') }}"></script>
  ...
  <script src="{{ asset('js/jqueryeasing/jquery.easing.min.js') }}"></script>
